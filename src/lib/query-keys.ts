...
export const queryKeys = {
  // ─── Queries ──────────────────────────────────────────────────────────────
  balances: (address: `0x${string}` | undefined, config: StorageConfig, chainId: number | undefined) =>
  ...
  deleteDataset: (address: `0x${string}` | undefined, chainId: number | undefined, dataSetId: string) =>
